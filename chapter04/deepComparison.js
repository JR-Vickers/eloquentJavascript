...
=== operator for that) or have their properties compared, you 
use the typeof operator. If it produces "object" for both 
values, you should do a deep comparison. But you have to take 
one silly exception into account: because of a historical 
...
// console.log(typeof(obj) === {here: {is: "an"}, object: 2})
