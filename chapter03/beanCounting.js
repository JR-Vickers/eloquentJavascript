...
found at position string.length - 1. In other words, a two-
character string has length 2, and its characters have 
positions 0 and 1.
...
the character that is to be counted (rather than counting only 
